function [x iter Loc] = BIHT2_AOP(b, A, x, K, L, miter, maxiter, alpha) 
%%
% BIHT2_AOP is the function used to recover signals from 1-bit measurements in 
...
% utilizes BIHT-L2 algorithm with this new measurements and corresponding 
% measurement system.
%
%                   Min.  Lambda.*phi(b,Ax)
%                   s.t.  |x|_0 <= K,  |x|_2 = 1,
