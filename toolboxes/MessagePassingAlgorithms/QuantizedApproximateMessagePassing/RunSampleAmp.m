function [mse, xhat, x] = RunSampleAmp
% Function runs Approximate Message Passing (AMP) reconstruction.
%
...
%
% See also CREATEQUANTIZER, QUANTIZEMEASUREMENTS, RECONSTRUCTAMP.
...
% Stopping criterion. Stop if absolute change in MSE < tol
tol = 1e-4;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Run Approximate Message Passing
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(gca, 'FontSize', 14);
grid on;
title('MSE of AMP reconstruction');
...
% Helper function used to plot results of RunSampleAmp.
